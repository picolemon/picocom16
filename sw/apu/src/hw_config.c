...
socket, which SPI it is driven by, and how it is wired.
    ...
    sd = sdcard.SDCard(spi, machine.Pin(9))  # Compatible with PCB
...
static spi_t spis[] = {  // One for each SPI.
    {
        .hw_inst = APU_SDCARD_SPI,  // SPI component
...
static sd_card_t sd_cards[] = {  // One for each SD card
    {
        ...
        .card_detect_gpio = 20,   // Card detect (breadboard)
        //.card_detect_gpio = 0,   // Card detect disable
